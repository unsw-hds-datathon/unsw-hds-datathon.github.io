...
* Enrol as a team of 4 or as an individual to be placed in a team. 
...
Participants will analyse data from the Australian and New Zealand Hip Fracture Registry (ANZHFR). Check out the [data](data.html) page for more details. 

#### The prizes

Top ranked teams will share in over $1,500 in prizes. 


#### Registration

Register online [here](https://forms.office.com/r/0aZ8vhheDM). All team members **must** register. Register as a team of 4 or enter the team name **Individual** to enrol individually and be placed in a team. 


#### Contact

For questions, information or accessibility queries, please contact <a href="mailto:o.perezconcha@unsw.edu.au">Dr Oscar Perez Concha</a> from the Center for Big Data Research in Health, UNSW. Accessibility requirements can also be noted in the [registration form](https://forms.office.com/r/0aZ8vhheDM). 
